...
import {SafeTransferLib} from "../../src/ERC4626Flatten.sol";
import {FixedPointMathLib} from "../../src/ERC4626Flatten.sol";
...
contract TestRPool is Ownable {
    ...
    */
    ...
    constructor(address _utils, address _ghoToken, uint256 _feeOnRPs, address _mainAdmin) Ownable(msg.sender) {
        s_utils = _utils;
    ...
    */
    ...
    function transferGp(uint256 _amount, address _to) public {
        MainVault(s_gpToken).transfer(_to, _amount);
    }
